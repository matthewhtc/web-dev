//This is has been called the module pattern, 
//it basically allows you to encapsulate private members on an object, by taking advantage of the use of closures.
var pomodoroClock = function() {
	 ...
	 */
	return {
		//initialization function to do all setup work
		init: function() {
			isPaused = pomodoroing = false; 
			studying = true; 
			setupButtons(); 
		},
		...
		stop: function() { //a stop task
		
		}, 

		reset: function() { //a reset task
